# <img src="matterbridge.svg" alt="Matterbridge Logo" width="64px" height="64px">&nbsp;&nbsp;&nbsp;Matterbridge KNX Plugin
...
This repository provides a Matterbridge plugin for KNX enabled Home Assistant environments.

## Features
- Parse KNX devices available in Home Assistant
- Create appropriate naming
- Publish to matter brigde

## ToDo

Per device configuration and persistent storage
